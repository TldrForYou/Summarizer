...
python summarization_train.py --model_name_or_path "google/pegasus-pubmed" --tokenizer_name "google/pegasus-pubmed" --use_auth_token True --dataset_name xsum --output_dir output_custom/ --use_fast_tokenizer True --cache_dir "/scratch/ws/0/anpo879a-work_scads/anpo879a-work_scads-1661299321/work_scads/hf_cache" --overwrite_cache True
